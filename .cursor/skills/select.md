...
The trigger matches the field shell (`aria-haspopup="listbox"`); the menu panel uses flat, `radius-full`, item padding `spacing-2` `spacing-3`, hover `neutral-tertiary-medium`, and an optional 16px checkmark at the inline start of the selected item.
...
- **No menu panel styled ad hoc** — use `dropdowns.md` tokens (`radius-full`, flat).
