...
| elevation-none | `none` |
| elevation-1 | `none` |
| elevation-2 | `0px 6px 20px rgba(22, 20, 18, 0.12)` |
| elevation-3 | `none` |
| elevation-4 | `none` |
| elevation-5 | `none` |
...
- **No drop shadow to fake depth** — cards and shells separate with the `default` (`#D0CBC7`) border and surface color, not with elevation.
